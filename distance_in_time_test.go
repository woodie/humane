...
func TestDistanceInTime(t *testing.T) {
	spec.Run(t, "humane.DistanceInTime", func(t *testing.T, context spec.G, it spec.S) {
		describe, beforeEach, justBeforeEach := context, it.BeforeEach, it.JustBeforeEach
		...
		describe("with no options", func() {
			var at *time.Time
			var result string
			justBeforeEach(func() { result = humane.DistanceInTime(at, base, humane.TimeOptions{}) })

			context("just now", func() {
				beforeEach(func() { at = ptr(base) })
			...
			context("45 seconds ago", func() {
				beforeEach(func() { at = ptr(base.Add(-45 * time.Second)) })
			...
			context("1 minute ago", func() {
				beforeEach(func() { at = ptr(base.Add(-1 * time.Minute)) })
			...
			context("3 minutes ago", func() {
				beforeEach(func() { at = ptr(base.Add(-3 * time.Minute)) })
			...
			context("1 hour ago", func() {
				beforeEach(func() { at = ptr(base.Add(-1 * time.Hour)) })
			...
			context("15 hours ago", func() {
				beforeEach(func() { at = ptr(base.Add(-15 * time.Hour)) })
			...
			context("30 hours ago", func() {
				beforeEach(func() { at = ptr(base.Add(-30 * time.Hour)) })
			...
			context("3 days ago", func() {
				beforeEach(func() { at = ptr(base.Add(-3 * 24 * time.Hour)) })
			...
			context("3 hours from now", func() {
				beforeEach(func() { at = ptr(base.Add(3 * time.Hour)) })
		...
		describe("with IncludeSeconds: true", func() {
			...
			context("1 second ago", func() {
				beforeEach(func() { at = ptr(base.Add(-1 * time.Second)) })
		...
		describe("nil handling", func() {
			...
			var result string
			justBeforeEach(func() { result = humane.DistanceInTime(nil, base, opts) })

			context("when at is nil and WhenNil is set", func() {
				beforeEach(func() { opts = humane.TimeOptions{WhenNil: "an unknown time"} })
		...
		describe("at the approximate-distance bucket table boundaries", func() {
			context("with Approximate: false", func() {
				...
				context("29 seconds ago", func() {
					beforeEach(func() { at = ptr(base.Add(-29 * time.Second)) })
				...
				context("30 seconds ago", func() {
					beforeEach(func() { at = ptr(base.Add(-30 * time.Second)) })
				...
				context("89 seconds ago", func() {
					beforeEach(func() { at = ptr(base.Add(-89 * time.Second)) })
				...
				context("90 seconds ago", func() {
					beforeEach(func() { at = ptr(base.Add(-90 * time.Second)) })
				...
				context("44 minutes 29 seconds ago", func() {
					beforeEach(func() { at = ptr(base.Add(-(44*time.Minute + 29*time.Second))) })
				...
				context("44 minutes 30 seconds ago", func() {
					beforeEach(func() { at = ptr(base.Add(-(44*time.Minute + 30*time.Second))) })
				...
				context("89 minutes 29 seconds ago", func() {
					beforeEach(func() { at = ptr(base.Add(-(89*time.Minute + 29*time.Second))) })
				...
				context("89 minutes 30 seconds ago", func() {
					beforeEach(func() { at = ptr(base.Add(-(89*time.Minute + 30*time.Second))) })
				...
				context("23 hours 59 minutes 29 seconds ago", func() {
					beforeEach(func() { at = ptr(base.Add(-(23*time.Hour + 59*time.Minute + 29*time.Second))) })
				...
				context("23 hours 59 minutes 30 seconds ago", func() {
					beforeEach(func() { at = ptr(base.Add(-(23*time.Hour + 59*time.Minute + 30*time.Second))) })
